...
L:RegisterTranslations("deDE", function() return {
	...
	["Invite all characters of the specified level in the guild to raid."] = "Alle Charaktere des angegebenen Levels in der Gilde in den Schlachtzug einladen.",
	...
	["All level %d or higher characters will be invited to raid in 10 seconds. Please leave your groups."] = "Alle Charakter der Stufe %d oder hoeher werde in 10 Sekunden eingeladen. Bitte verlasst eure Gruppen.",
    ["off"] = "aus",
} end )
